        ...
        <div class="container flex flex-wrap justify-between items-center mx-auto ">
            ...
            <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
                <ul class="flex flex-col mt-4 font-OpenSauce font-medium md:flex-row md:space-x-8 md:mt-0 md:text-sm ">
                    ...
                    <li>
                        <a href="#" class="block py-2 pr-4 pl-3 text-gray-700  ">Purchase</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pr-4 pl-3 text-gray-700  ">Auctions</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pr-4 pl-3 text-gray-700  ">Information</a>
                    </li>
